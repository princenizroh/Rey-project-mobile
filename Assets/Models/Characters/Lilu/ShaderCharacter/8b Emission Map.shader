...
Shader "Shantanu Bhadoria/Basic/8b Emit Map" {
	Properties {
		...
		_EmitStrength ("Emit Strength", Range( 0.0, 2.0 )) = 0
	...
	SubShader {
		Pass{
			...
			float4 frag( vertexOutput i ): COLOR {
				...
				float3 lightFinal = diffuseReflection + ( specularReflection * tex.a ) + rimLighting + UNITY_LIGHTMODEL_AMBIENT.rgb + ( texE.xyz * _EmitStrength);
				//lightFinal = tex.a;
