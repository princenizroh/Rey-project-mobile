    ...
    public class KuntiAI : MonoBehaviour
    {
        ...
        private void Chasing()
        {
            ...
            if (distanceToTarget <= radiusHit) // Jika SANGAT dekat (dalam death zone)
            {
                ...
                // }
                // Jangan bunuh player di sini, cukup siapkan transisi ke attack
        ...
        {
            FindAnyObjectByType<PlayerTriggerKuntiAISpawn>()?.DisableTrigger(); // Disable spawn trigger if exists
